...
HD_PWD='C:/Users/march/Vivado_projects/fingerprint/fingerprint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nexys4ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_nexys4ddr.tcl
