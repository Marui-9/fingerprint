...
HD_PWD='C:/Users/march/Vivado_projects/fingerprint/fingerprint.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_nexys4ddr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_nexys4ddr.tcl -notrace
