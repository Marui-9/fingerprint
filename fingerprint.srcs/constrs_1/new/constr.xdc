...
#create_clock -name clk50 -period 20.0 [get_pins top_nexys4ddr/u_clk_wiz/inst/clk_out1]
#create_clock -name clk25 -period 40.0 [get_pins top_nexys4ddr/u_clk_wiz/inst/clk_out2]
#set_clock_groups -asynchronous -group {get_clocks sys_clk_pin} -group {get_clocks clk50} -group {get_clocks clk25}

# 50 MHz from clk_wiz
#create_generated_clock -add -name clk50  -source [get_ports {CLK100MHZ}]  [get_pins {top_nexys4ddr/u_clk_wiz/inst/clk_out1}]

# 25 MHz from clk_wiz
#create_generated_clock -add -name clk25 -source [get_ports {CLK100MHZ}]   [get_pins {top_nexys4ddr/u_clk_wiz/inst/clk_out2}]
##Switches
